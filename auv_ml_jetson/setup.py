...
setup(
    ...
    entry_points={
        "console_scripts": [
            "yolo_inference_server_gate = auv_ml_jetson.yolo_inference_server_gate:main",
            # "yolo_inference_test_gate = auv_ml.yolo_inference_test_gate:main",
            "yolo_inference_server_bucket = auv_ml_jetson.yolo_inference_server_bucket:main",
        ],
    },
)
