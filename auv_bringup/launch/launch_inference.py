...
def generate_launch_description():
    ...
    yolo_gate_node = Node(
        ...
        condition=IfCondition(PythonExpression([
            "('", LaunchConfiguration("front_inference"), "' == 'gate') or ('",
            LaunchConfiguration("down_inference"), "' == 'gate')"
        ]))
    )
    ...
    yolo_bucket_node = Node(
        ...
        output='screen',
        condition=IfCondition(PythonExpression([
            "('", LaunchConfiguration("front_inference"), "' == 'bucket') or ('",
            LaunchConfiguration("down_inference"), "' == 'bucket')"
        ]))
    )
    ...
    infer_camera_front_node = Node(
        ...
        condition=UnlessCondition(PythonExpression(["'", LaunchConfiguration("front_inference"), "' == 'None'"]))
    )
    infer_camera_down_node = Node(
        ...
        condition=UnlessCondition(PythonExpression(["'", LaunchConfiguration("down_inference"), "' == 'None'"]))
    )
    ...
    show_camera_front_raw = Node(
        ...
        output='screen',
        condition=IfCondition(PythonExpression(["'", LaunchConfiguration("front_inference"), "' == 'None'"]))
    )
    show_camera_down_raw = Node(
        ...
        output='screen',
        condition=IfCondition(PythonExpression(["'", LaunchConfiguration("down_inference"), "' == 'None'"]))
    )
